    ...
    return (
      <div className="flex items-center justify-center h-full">
        <div className="text-center">
          ...
          <p className="text-gray-400">Please complete the setup process to see your prop firm rules.</p>
        </div>
      </div>
    );
  }

  const currentPropFirm = propFirm;
  const currentAccountSize = accountConfig.size;
  ...
  const rules = [
    {
      ...
      value: currentPropFirm.dailyLossLimit,
      status: 'safe',
    ...
    },
    {
      ...
      value: currentPropFirm.maximumLoss,
      status: 'safe',
    ...
    },
    {
      ...
      value: currentPropFirm.profitTargets,
      status: 'pending',
    ...
    },
    {
      ...
      value: currentPropFirm.minTradingDays,
      status: 'pending',
    ...
    },
    {
      ...
      value: currentPropFirm.overnightPositions,
      status: 'info',
    ...
    },
    {
      ...
      value: currentPropFirm.newsTrading,
      status: 'info',
    ...
    <>
      ...
      <div id="prop-firm-rules-page" className="page-content">
        <div className="page-header">
          <div>
            <h1 className="page-title">{currentPropFirm.name} Rules</h1>
